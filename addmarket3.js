...
var contract_address = '0x8bD9600Ec3a996FDf83ce89CEfFf50610BC3F0E5';
...
module.exports = function() {
  ...
  async function createMarket() {
    let factory = await RealityCardsFactory.at(contract_address);
    await factory.createMarket(andrewsAddress, numberOfTokens, augurCashAddressKovan, realitioAddressKovan, marketLockingTimeTest, oracleResolutionTimeTest, templateId, question, questionId, useExistingQuestion, arbitrator, timeoutTest, tokenName);
  }
