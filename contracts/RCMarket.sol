            ...
            */
            ...
            if (!_foreclosed && !_limitHit && !_marketLocked) {
                ...
                if (_timeUserForeclosed < _tokenTimeLimitTimestamp) {
                    //  console.log(" CASE 7 A");
                    // user foreclosed before time limit
                    _timeOfThisCollection = _timeUserForeclosed;
                    _newOwner = true;
                    _refundTime = 0;
                } else {
                    //  console.log("CASE 7 B");
