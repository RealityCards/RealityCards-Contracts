...
contract('RealityCardsTests XdaiV1', (accounts) => {
  ...
  beforeEach(async () => {
    ...
    console.log("xdaiproxy is ",xdaiproxy.address);
    console.log("mainnetproxy is ",mainnetproxy.address);
    // set proxy addresses in various places
...
//     rcfactory2 = await RCFactory.new(treasury.address, xdaiproxy.address);
