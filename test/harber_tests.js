...
//     ////////////////////////
//     await harber.step1checkMarketsEnded(); 
//     await harber.step2checkMarketsResolved(); 
//     await harber.step3withdrawFromAugur(); 
//     ////////////////////////
...
//     ////////////////////////
//     await harber.step1checkMarketsEnded(); 
//     await shouldFail.reverting.withMessage(harber.step2BemergencyExit(), "Must wait 6 months for Augur Oracle");
...
//   it('test return deposits work (before payout but after step3withdrawFromAugur)', async () => {
//     /////// SETUP //////
//     await cash.faucet(web3.utils.toWei('100', 'ether'),{ from: user0 });
//     await cash.approve(harber.address, web3.utils.toWei('100', 'ether'),{ from: user0 });
//     await cash.faucet(web3.utils.toWei('100', 'ether'),{ from: user1 });
...
//   it('test return deposits work before step3withdrawFromAugur)', async () => {
//     /////// SETUP //////
//     await cash.faucet(web3.utils.toWei('100', 'ether'),{ from: user0 });
//     await cash.approve(harber.address, web3.utils.toWei('100', 'ether'),{ from: user0 });
//     await cash.faucet(web3.utils.toWei('100', 'ether'),{ from: user1 });
...
//     await market3.setResult(2);
//     await harber.step1checkMarketsEnded(); 
//     await shouldFail.reverting.withMessage(harber.step2checkMarketsResolved(), "Markets have not resolved yet");
//     await shouldFail.reverting.withMessage(harber.step3withdrawFromAugur(), "Must wait for market resolution");
...
//     // var marketExpectedResolutionTime = await harber.marketExpectedResolutionTime();
//     // var currentTime = await time.latest();
//     // console.log("marketExpectedResolutionTime is ", marketExpectedResolutionTime, "currentTime is", currentTime);
//     //// TESTS ////
//     // call step 2 before step 1 done
//     await shouldFail.reverting.withMessage(harber.step2checkMarketsResolved(), "Must wait for markets to end");
//     //call step 1 before markets ended
//     await shouldFail.reverting.withMessage(harber.step1checkMarketsEnded(), "Markets have not finished yet");
//     await time.increase(time.duration.hours(1)); 
//     // call step 1 after markets ended, should work
//     await harber.step1checkMarketsEnded(); 
//     // call step 1 twice
//     await shouldFail.reverting.withMessage(harber.step1checkMarketsEnded(), "Step1 can only be completed once");
//     });
    ...
    it('check that _revertToPreviousOwner does not revert more than ten times ', async () => {
      ...
      await harber.newRental(web3.utils.toWei('1.1', 'ether'),2,web3.utils.toWei('1', 'ether'),{ from: user1 });
      await harber.newRental(web3.utils.toWei('1.2', 'ether'),2,web3.utils.toWei('1', 'ether'),{ from: user0 });
      await harber.newRental(web3.utils.toWei('1.3', 'ether'),2,web3.utils.toWei('1', 'ether'),{ from: user1 });
      // get user 2 and 3 to rent it more than ten times
      await harber.newRental(web3.utils.toWei('1.4', 'ether'),2,web3.utils.toWei('1', 'ether'),{ from: user2 });
      await harber.newRental(web3.utils.toWei('1.5', 'ether'),2,web3.utils.toWei('1', 'ether'),{ from: user3 });
      await harber.newRental(web3.utils.toWei('1.6', 'ether'),2,web3.utils.toWei('1', 'ether'),{ from: user2 });
      await harber.newRental(web3.utils.toWei('1.7', 'ether'),2,web3.utils.toWei('1', 'ether'),{ from: user3 });
      await harber.newRental(web3.utils.toWei('1.8', 'ether'),2,web3.utils.toWei('1', 'ether'),{ from: user2 });
      await harber.newRental(web3.utils.toWei('1.9', 'ether'),2,web3.utils.toWei('1', 'ether'),{ from: user3 });
      await harber.newRental(web3.utils.toWei('2.0', 'ether'),2,web3.utils.toWei('1', 'ether'),{ from: user2 });
      await harber.newRental(web3.utils.toWei('2.1', 'ether'),2,web3.utils.toWei('1', 'ether'),{ from: user3 });
      await harber.newRental(web3.utils.toWei('2.2', 'ether'),2,web3.utils.toWei('1', 'ether'),{ from: user2 });
      await harber.newRental(web3.utils.toWei('2.3', 'ether'),2,web3.utils.toWei('1', 'ether'),{ from: user3 });
      await harber.newRental(web3.utils.toWei('2.4', 'ether'),2,web3.utils.toWei('1', 'ether'),{ from: user2 });
      await harber.newRental(web3.utils.toWei('2.5', 'ether'),2,web3.utils.toWei('1', 'ether'),{ from: user3 });
      ...
      assert.equal(price, web3.utils.toWei('1.4', 'ether'));
      });
