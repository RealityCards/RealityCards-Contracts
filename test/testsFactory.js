...
//   it('check exitAll', async () => {
//     await cash.faucet(web3.utils.toWei('200', 'ether'),{ from: user0 });
//     await cash.approve(realitycards.address, web3.utils.toWei('200', 'ether'),{ from: user0 });
//     await cash.faucet(web3.utils.toWei('100', 'ether'),{ from: user1 });
//     await cash.approve(realitycards.address, web3.utils.toWei('100', 'ether'),{ from: user1 });
//     await realitycards.newRental(web3.utils.toWei('1', 'ether'),0,web3.utils.toWei('50', 'ether'),{ from: user0 });
//     await realitycards.newRental(web3.utils.toWei('50', 'ether'),1,web3.utils.toWei('50', 'ether'),{ from: user0 });
//     await realitycards.newRental(web3.utils.toWei('1', 'ether'),2,web3.utils.toWei('50', 'ether'),{ from: user0 });
//     await time.increase(time.duration.weeks(1)); 
//     await realitycards.newRental(web3.utils.toWei('2', 'ether'),2,web3.utils.toWei('50', 'ether'),{ from: user1 });
//     await time.increase(time.duration.weeks(1)); 
//     // 0 has remaining deposits of: 0: 50 - 14 = 36, + 50 - 7 = 43; = 79
//     await cash.resetBalance(user0);
//     await realitycards.exitAll({ from: user0 });
//     var depositReturned = await cash.balanceOf(user0);
//     var depositReturnedShouldBe = web3.utils.toWei('79', 'ether');
//     var difference = Math.abs(depositReturned.toString()-depositReturnedShouldBe.toString())
//     assert.isBelow(difference/depositReturned,0.00001);
//   });

//   it('test withdraw- zero winners', async () => {
//     /////// SETUP //////
//     await cash.faucet(web3.utils.toWei('100', 'ether'),{ from: user0 });
//     await cash.approve(realitycards.address, web3.utils.toWei('100', 'ether'),{ from: user0 });
//     await cash.faucet(web3.utils.toWei('100', 'ether'),{ from: user1 });
...
//     await shouldFail.reverting.withMessage(rcfactory.createMarket(numberOfTokens,marketLockingTime, oracleResolutionTime, templateId, question, questionId, useExistingQuestion, arbitrator, timeout, tokenName), "Content hash does not match");
...
//     await cash.faucet(web3.utils.toWei('100000', 'ether'),{ from: user1 });
//     await cash.approve(realitycards.address, web3.utils.toWei('100000', 'ether'),{ from: user1 });
//     await cash.faucet(web3.utils.toWei('100000', 'ether'),{ from: user2 });
//     await cash.approve(realitycards.address, web3.utils.toWei('100000', 'ether'),{ from: user2 })
//     await cash.faucet(web3.utils.toWei('100000', 'ether'),{ from: user3 });
//     await cash.approve(realitycards.address, web3.utils.toWei('100000', 'ether'),{ from: user3 });
//     await cash.faucet(web3.utils.toWei('100000', 'ether'),{ from: user4 });
//     await cash.approve(realitycards.address, web3.utils.toWei('100000', 'ether'),{ from: user4 });
//     await cash.faucet(web3.utils.toWei('100000', 'ether'),{ from: user5 });
//     await cash.approve(realitycards.address, web3.utils.toWei('100000', 'ether'),{ from: user5 });
//     await cash.faucet(web3.utils.toWei('100000', 'ether'),{ from: user6 });
//     await cash.approve(realitycards.address, web3.utils.toWei('100000', 'ether'),{ from: user6 });
//     await cash.faucet(web3.utils.toWei('100000', 'ether'),{ from: user7 });
...
//     await realitycards.collectRentAllTokens();
//     await realitycards.depositDai(web3.utils.toWei('1', 'ether'),3,{ from: user5 });
//     await realitycards.newRental(web3.utils.toWei('1', 'ether'),2,web3.utils.toWei('10', 'ether'),{ from: user7});
//     await realitycards.collectRentAllTokens();
//     await realitycards.newRental(web3.utils.toWei('2', 'ether'),2,web3.utils.toWei('10', 'ether'),{ from: user2 });
//     await realitycards.newRental(web3.utils.toWei('100', 'ether'),2,web3.utils.toWei('10', 'ether'),{ from: user0 });
//     await realitycards.collectRentAllTokens();
//     await realitycards.newRental(web3.utils.toWei('1', 'ether'),5,web3.utils.toWei('10', 'ether'),{ from: user0 });
//     await realitycards.depositDai(web3.utils.toWei('1', 'ether'),0,{ from: user0 });
//     await time.increase(time.duration.weeks(2)); 
//     await realitycards.newRental(web3.utils.toWei('1', 'ether'),0,web3.utils.toWei('10', 'ether'),{ from: user0 });
//     await realitycards.newRental(web3.utils.toWei('74', 'ether'),0,web3.utils.toWei('10', 'ether'),{ from: user3 });
//     await realitycards.exitAll({ from: user2 });
//     await realitycards.newRental(web3.utils.toWei('6', 'ether'),2,web3.utils.toWei('10', 'ether'),{ from: user0 });
//     await time.increase(time.duration.weeks(2)); 
//     await realitycards.collectRentAllTokens();
...
//     await realitycards.withdrawDeposit(web3.utils.toWei('15', 'ether'),2,{ from: user4 });
//     await realitycards.depositDai(web3.utils.toWei('1', 'ether'),3,{ from: user8 });
//     await realitycards.depositDai(web3.utils.toWei('1', 'ether'),4,{ from: user4 });
//     await realitycards.newRental(web3.utils.toWei('8300', 'ether'),2,web3.utils.toWei('5000', 'ether'),{ from: user0 });
//     await time.increase(time.duration.weeks(2)); 
//     await realitycards.newRental(web3.utils.toWei('1', 'ether'),8,web3.utils.toWei('10', 'ether'),{ from: user0 });
//     await realitycards.newRental(web3.utils.toWei('1', 'ether'),5,web3.utils.toWei('10', 'ether'),{ from: user8 });
//     await realitycards.exitAll({ from: user7 });
//     await realitycards.collectRentAllTokens();
//     await realitycards.newRental(web3.utils.toWei('1', 'ether'),4,web3.utils.toWei('10', 'ether'),{ from: user0 });
//     await realitycards.collectRentAllTokens();
//     await realitycards.withdrawDeposit(web3.utils.toWei('10', 'ether'),8,{ from: user0 });
//     await realitycards.newRental(web3.utils.toWei('8387', 'ether'),5,web3.utils.toWei('1000', 'ether'),{ from: user5 });
//     await realitycards.newRental(web3.utils.toWei('2', 'ether'),8,web3.utils.toWei('10', 'ether'),{ from: user6 });
//     await time.increase(time.duration.weeks(2)); 
//     await realitycards.newRental(web3.utils.toWei('5', 'ether'),4,web3.utils.toWei('10', 'ether'),{ from: user0 });
//     await realitycards.exit(8,{ from: user0 });
//     await realitycards.changePrice(web3.utils.toWei('10', 'ether'),4,{ from: user0});
//     await realitycards.collectRentAllTokens();
//     await realitycards.withdrawDeposit(web3.utils.toWei('5', 'ether'),5,{ from: user5 });
//     await realitycards.newRental(web3.utils.toWei('10000', 'ether'),2,web3.utils.toWei('10000', 'ether'),{ from: user3 });
//     await time.increase(time.duration.weeks(2)); 
//     await realitycards.newRental(web3.utils.toWei('1', 'ether'),0,web3.utils.toWei('10', 'ether'),{ from: user0 });
//     await realitycards.depositDai(web3.utils.toWei('1', 'ether'),8,{ from: user5 });
//     await realitycards.collectRentAllTokens();
//     await realitycards.exit(0,{ from: user0 });
//     await realitycards.newRental(web3.utils.toWei('20000', 'ether'),2,web3.utils.toWei('200000', 'ether'),{ from: user8 });
//     await realitycards.depositDai(web3.utils.toWei('1', 'ether'),3,{ from: user7 });
//     await realitycards.depositDai(web3.utils.toWei('1', 'ether'),1,{ from: user8 });
//     await realitycards.newRental(web3.utils.toWei('30000', 'ether'),2,web3.utils.toWei('30000', 'ether'),{ from: user0 });
//     await time.increase(time.duration.weeks(2)); 
//     await realitycards.newRental(web3.utils.toWei('1', 'ether'),7,web3.utils.toWei('10', 'ether'),{ from: user7 });
//     await realitycards.withdrawDeposit(web3.utils.toWei('7', 'ether'),2,{ from: user8 });
//     await realitycards.newRental(web3.utils.toWei('1', 'ether'),1,web3.utils.toWei('10', 'ether'),{ from: user4 });
//     await time.increase(time.duration.weeks(2)); 
//     await realitycards.newRental(web3.utils.toWei('1', 'ether'),9,web3.utils.toWei('10', 'ether'),{ from: user2 });
//     await realitycards.exitAll({ from: user0 });
...
//     await realitycards.withdraw({ from: user0 });
//     var winningsSentToUser = await cash.balanceOf.call(user0);
//     winningsSentToUser = Math.abs(winningsSentToUser.toString() - 1);
//     assert.isAbove(winningsSentToUser,0);
//     await realitycards.withdraw({ from: user4 });
//     var winningsSentToUser = await cash.balanceOf.call(user4);
//     winningsSentToUser = Math.abs(winningsSentToUser.toString() - 1);
//     assert.isAbove(winningsSentToUser,0);
//     await realitycards.withdraw({ from: user5 });
//     var winningsSentToUser = await cash.balanceOf.call(user5);
//     winningsSentToUser = Math.abs(winningsSentToUser.toString() - 1);
//     assert.isAbove(winningsSentToUser,0);
//     await realitycards.withdraw({ from: user6 });
//     var winningsSentToUser = await cash.balanceOf.call(user6);
//     winningsSentToUser = Math.abs(winningsSentToUser.toString() - 1);
//     assert.isAbove(winningsSentToUser,0);
//     await realitycards.withdraw({ from: user8 });
//     var winningsSentToUser = await cash.balanceOf.call(user8);
//     winningsSentToUser = Math.abs(winningsSentToUser.toString() - 1);
//     assert.isAbove(winningsSentToUser,0);
//     //losers
//     await shouldFail.reverting.withMessage(realitycards.withdraw({ from: user1 }), "Not a winner");
...
//     await cash.faucet(web3.utils.toWei('100', 'ether'),{ from: user3 });
//     await cash.approve(realitycards.address, web3.utils.toWei('100', 'ether'),{ from: user3 });
//     await realitycards.sponsor(web3.utils.toWei('75', 'ether'),{ from: user3 });
//     /////// SETUP //////
//     await cash.faucet(web3.utils.toWei('100', 'ether'),{ from: user0 });
//     await cash.approve(realitycards.address, web3.utils.toWei('100', 'ether'),{ from: user0 });
//     await cash.faucet(web3.utils.toWei('100', 'ether'),{ from: user1 });
...
//     await time.increase(time.duration.weeks(2)); 
//     // winner 1: 
//     // totalcollected = 75, //actually now 150
//     // paid: 0: 17, 1: 34, 2: 30
//     // total days: 22 = 1900800 seconds
//     // time: 0: 7 days (604800) 1: 7 days 2: 8 days (691200)
//     // winner 2: 
...
//     var difference = Math.abs(winningsSentToUser.toString() - winningsShouldBe.toString());
//     assert.isBelow(difference/winningsSentToUser,0.00001);
//     //check user3 winnings 
//     await realitycards.withdraw({ from: user3 });
//     var winningsSentToUser = await cash.balanceOf.call(user3);
//     var winningsShouldBe = ether('75');
//     var difference = Math.abs(winningsSentToUser.toString() - winningsShouldBe.toString());
//     assert.isBelow(difference/winningsSentToUser,0.00001);
//     //check user5 winnings, should fail cos didn't pay any rent
...
//     var marketLockingTime = 69420; 
//     await shouldFail.reverting.withMessage(rcfactory.createMarket(numberOfTokens,marketLockingTime, oracleResolutionTime, templateId, question, questionId, useExistingQuestion, arbitrator, timeout, tokenName), "Invalid timestamps");
