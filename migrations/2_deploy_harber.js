...
module.exports = function(deployer, network) {
  ...
  if(network === "kovan") {
    ...
    return deployer.deploy(Harber, andrewsAddress, deployedToken.address, augurCashAddressKovan, augurMarketAddress,augurShareTokenAddress, augurMainAddress, marketedExpectedResolutionTime);
  }).then((deployedHarber) => {
