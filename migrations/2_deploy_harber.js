...
module.exports = function (deployer, network) {
  ...
  if (network === "kovan") {
    deployer.deploy(Token, "Harber.io", "HARB").then((deployedToken) => {
      return deployer.deploy(Harber, andrewsAddress, deployedToken.address, augurCashAddressKovan, vatDaiAddressKovan, realitioAddressKovan, marketedExpectedResolutionTime);
    }).then((deployedHarber) => {
