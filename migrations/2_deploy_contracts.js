...
module.exports = function (deployer, network) {
  ...
  if (network === "kovan") {
    deployer.deploy(RealityCards, andrewsAddress, numberOfTokens, augurCashAddressKovan, realitioAddressKovan, marketExpectedResolutionTime, templateId, question, arbitrator, timeout);
